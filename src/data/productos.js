...
export const productos = [
  {
    ...
    colores: [],
    fotos: [],
    descripcion: 'Personalizado con foto a elección. Llavero con forma de cámara que se abre y revela la foto que tú elijas.',
    detalles: [
      { etiqueta: 'Tu foto',             valor: 'Impresa a color, elegida por ti' },
      { etiqueta: 'Colores',             valor: 'Negro · Gris · Azul' },
      { etiqueta: 'Argolla',             valor: 'Metálica de cierre, incluida' },
      { etiqueta: 'Lista en',            valor: '2-3 días hábiles' },
      { etiqueta: 'Entrega',             valor: 'Trujillo o courier nacional' },
      { etiqueta: 'Campaña activa',      valor: 'Día del Padre — 21 de junio 2026' },
    ],
    whatsapp_texto: 'Pedir mi Cámara de los Recuerdos',
    descuentos_cantidad: [],
    activo: true,
  },
  {
